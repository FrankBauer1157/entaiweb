...
<div class="d-flex align-items-center mb-4">
    ...
    <h3 class="mb-0" style="color: #1A3C1A;"><i class="fas fa-plus-circle me-2" style="color: #2E7D32;"></i>Add New Package</h3>
</div>
        ...
        <form method="POST" action="{{ route('admin.packages.store') }}" enctype="multipart/form-data">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="category" id="category" class="form-control" value="{{ old('category') }}" required placeholder="e.g. Safari, Beach, Mountain">
                </div>
                <div class="col-12">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="duration" id="duration" class="form-control" value="{{ old('duration') }}" required placeholder="e.g. 3 Days / 2 Nights">
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="rating" id="rating" class="form-control" value="{{ old('rating', 0) }}" step="0.1" min="0" max="5">
                </div>
                <div class="col-12">
                    <label for="inclusions" class="form-label">Inclusions</label>
                    <textarea name="inclusions" id="inclusions" class="form-control" rows="3" placeholder="One per line">{{ old('inclusions') }}</textarea>
                </div>
                <div class="col-md-6">
                    <label for="image" class="form-label">Package Image</label>
                    <input type="file" name="image" id="image" class="form-control" accept="image/*" onchange="previewImage(event)">
                    <img id="imagePreview" src="#" alt="Preview" class="mt-3 rounded" style="display:none; max-width:300px; max-height:200px; object-fit:cover;">
                </div>
